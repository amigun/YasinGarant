def get(msg, **kwargs):
    ...
    elif msg == 'new_offer_deal':
        message = '➕ Новое предложение о сделке!'
    elif msg == 'deal_info':
        if kwargs['commission'] == 2:
            message = f'🧑 *Покупатель:* {kwargs["buyer"]}\nℹ️ *Условие сделки:* {kwargs["condition"]}\n💰 *Цена:* {kwargs["price"]} руб\.\n🎅 *Кто платит комиссию*: Продавец \(вы получите {int(kwargs["price"]-kwargs["price"]/100*5)} руб\.\)'
        elif kwargs['commission'] == 1:
            message = f'🧑 *Покупатель:* {kwargs["buyer"]}\nℹ️ *Условие сделки:* {kwargs["condition"]}\n💰 *Цена:* {kwargs["price"]} руб\.\n🧑 *Кто платит комиссию*: Покупатель'
        elif kwargs['commission'] == 0:
            message = f'🧑 *Покупатель:* {kwargs["buyer"]}\nℹ️ *Условие сделки:* {kwargs["condition"]}\n💰 *Цена:* {kwargs["price"]} руб\.\n👨‍❤️‍👨 *Кто платит комиссию:* Пополам \(вы получите {int(kwargs["price"]-kwargs["price"]/100*2.5)} руб\.\)'
